...
async def setup():
    ...
    guild.role_moderator     = 1056979442569855106  # put in the role IDs for your server here
    guild.role_birthday      = 1056979467844735056  # put in the role IDs for your server here
    guild.role_sub_mod       = 1056979443886866473  # put in the role IDs for your server here
    guild.role_genius        = 1056979455484121128  # put in the role IDs for your server here
    guild.role_dev           = 1056979438648176700  # put in the role IDs for your server here
    ...
    # required for filter
    guild.channel_development    = 1056979479517483049  # put in the channel IDs for your server here
    ...
    guild.filter_excluded_channels  = ['1056979478234021950', '1056979454045458562']  # put in a channel if you want (ignored in filter)
